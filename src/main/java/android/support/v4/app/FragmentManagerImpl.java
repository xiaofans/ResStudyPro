...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    static final Interpolator ACCELERATE_QUINT = new AccelerateInterpolator(Formula.SIZE3_RATIO);
    ...
    static final Interpolator DECELERATE_QUINT = new DecelerateInterpolator(Formula.SIZE3_RATIO);
