...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * Paragraph.CODE_TEXTSIZE_RATIO)), Integer.MIN_VALUE);
