...
public class g {
    ...
    public static class a {
        ...
        public int d(int i) {
            return (this.g == -1 || this.g < 90 || this.g > StatConstant.DEFAULT_FORCE_UPLOAD_SECOND) ? i : this.g * 1000;
        }
        ...
        public long a(long j) {
            return (this.j != -1 && this.j >= 48) ? com.umeng.analytics.a.i * ((long) this.j) : j;
        }
