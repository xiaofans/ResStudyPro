                ...
                if (variableElement.getModifiers().contains(Modifier.STATIC)) {
                    ...
                    if (variableElement.getAnnotation(PrimaryKey.class) != null) {
                        if (this.primaryKey != null) {
                            Utils.error(String.format("@PrimaryKey cannot be defined more than once. It was found here \"%s\" and here \"%s\"", new Object[]{this.primaryKey.getSimpleName().toString(), variableElement.getSimpleName().toString()}));
                            return false;
