...
public class Constants {
    static final Map<String, String> CASTING_TYPES = new HashMap();
    public static final String DEFAULT_MODULE_CLASS_NAME = "DefaultRealmModule";
    static final Map<String, String> JAVA_TO_COLUMN_TYPES = new HashMap();
    static final Map<String, String> JAVA_TO_REALM_TYPES = new HashMap();
    static final Map<String, String> NULLABLE_JAVA_TYPES = new HashMap();
