    ...
    public static class Builder {
        ...
        public Builder encryptionKey(byte[] key) {
            if (key == null) {
                ...
                throw new IllegalArgumentException(String.format("The provided key must be %s bytes. Yours was: %s", new Object[]{Integer.valueOf(64), Integer.valueOf(key.length)}));
            } else {
                this.key = key;
                return this;
            }
