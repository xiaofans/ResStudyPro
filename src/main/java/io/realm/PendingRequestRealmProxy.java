...
public class PendingRequestRealmProxy extends PendingRequest implements RealmObjectProxy {
    ...
    public static void validateTable(ImplicitTransaction transaction) {
        if (transaction.hasTable("class_PendingRequest")) {
            ...
            } else if (!columnTypes.containsKey("uri")) {
                throw new RealmMigrationNeededException(transaction.getPath(), "Missing field 'uri'");
            } else if (columnTypes.get("uri") != ColumnType.STRING) {
    ...
    public static PendingRequest createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            } else if (name.equals("uri") && reader.peek() != JsonToken.NULL) {
    ...
    public static PendingRequest copy(Realm realm, PendingRequest newObject, boolean update, Map<RealmObject, RealmObjectProxy> cache) {
        ...
        realmObject.setMethod(newObject.getMethod() != null ? newObject.getMethod() : "");
        realmObject.setUri(newObject.getUri() != null ? newObject.getUri() : "");
        realmObject.setResourceType(newObject.getResourceType() != null ? newObject.getResourceType() : "");
        realmObject.setResourceId(newObject.getResourceId() != null ? newObject.getResourceId() : "");
        realmObject.setRequestParam(newObject.getRequestParam() != null ? newObject.getRequestParam() : "");
        realmObject.setRequestParamType(newObject.getRequestParamType() != null ? newObject.getRequestParamType() : "");
