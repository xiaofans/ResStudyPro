...
public final class Realm implements Closeable {
    ...
    private static Durability defaultDurability = Durability.FULL;
    ...
    private static synchronized Realm createAndValidate(RealmConfiguration configuration, boolean validateSchema, boolean autoRefresh) {
        ...
        synchronized (Realm.class) {
            ...
            if (realm2 != null) {
                ...
                if (currentVersion != -1 && currentVersion < requiredVersion && validateSchema) {
                    realm2.close();
                ...
                } else if (currentVersion == -1 || requiredVersion >= currentVersion || !validateSchema) {
                    if (validateSchema) {
                        try {
