...
public class PushManager {
    ...
    public boolean sendFeedbackMessage(Context context, String str, String str2, int i) {
        ...
        Intent a = a();
        a.putExtra("action", "sendFeedbackMessage");
    ...
    public boolean setHeartbeatInterval(Context context, int i) {
        ...
        Intent a = a();
        a.putExtra("action", "setHeartbeatInterval");
    ...
    public boolean setSilentTime(Context context, int i, int i2) {
        ...
        Intent a = a();
        a.putExtra("action", "setSilentTime");
    ...
    public boolean setSocketTimeout(Context context, int i) {
        ...
        Intent a = a();
        a.putExtra("action", "setSocketTimeout");
    ...
    public void stopService(Context context) {
        Intent a = a();
        a.putExtra("action", "stopService");
        context.sendBroadcast(a);
    }

    public void turnOffPush(Context context) {
        Intent a = a();
        a.putExtra("action", "turnOffPush");
        context.sendBroadcast(a);
    }
