...
public class SdkDownLoader {
    ...
    Handler d;
    String[] e = new String[]{FieldType.FOREIGN_ID_FIELD_SUFFIX, Downloads._DATA, Downloads.COLUMN_FILE_NAME_HINT, "status", Downloads.COLUMN_TOTAL_BYTES, Downloads.COLUMN_CURRENT_BYTES};
    private Context f;
