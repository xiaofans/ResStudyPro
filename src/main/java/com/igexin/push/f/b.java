...
public class b {
    private static final String a = (k.a + "_FileUtils");
    ...
    public static void a() {
        ...
        try {
            ...
            if (file.exists() || file.createNewFile()) {
                fileOutputStream = new FileOutputStream(g.Y);
                try {
                    fileOutputStream.write(a.b((("v01" + g.x) + String.valueOf(g.r) + "|" + g.a + "|" + g.s).getBytes(), g.B));
    ...
    public static void e() {
        ...
        if (g.z != null) {
            ...
            try {
                ...
                try {
                    fileOutputStream.write(g.z.getBytes("utf-8"));
                    if (fileOutputStream != null) {
                        try {
                            fileOutputStream.close();
                        } catch (Exception e) {
