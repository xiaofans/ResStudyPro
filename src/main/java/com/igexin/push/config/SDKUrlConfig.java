...
public class SDKUrlConfig {
    ...
    public static String[] CONFIG_ADDRESS_IPS = new String[]{"http://sdk.open.phone.igexin.com/api.php"};
    ...
    public static String[] LOG_ADDRESS_IPS = new String[]{"http://sdk.open.phone.igexin.com/api.php"};
    public static String[] STATE_ADDRESS_IPS = new String[]{"http://sdk.open.phone.igexin.com/api.php"};
    public static String[] XFR_ADDRESS_IPS = new String[]{"socket://sdk.open.talk.igexin.com:5224", "socket://sdk.open.talk.getui.net:5224", "socket://sdk.open.talk.gepush.com:5224"};
    public static String[] XFR_ADDRESS_IPS_BAK = new String[]{"socket://sdk.open.talk.igexin.com:5224"};
    private static String[] a;
    private static String b = "HZ";
