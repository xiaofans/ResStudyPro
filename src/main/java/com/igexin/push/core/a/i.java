        ...
        if (obj instanceof k) {
            ...
            if (!g.m) {
                ...
                if (((k) obj).a) {
                    ...
                    try {
                        if ((System.currentTimeMillis() - g.G) - com.umeng.analytics.a.h > 0) {
                            e.a().j();
                        }
                    } catch (Exception e3) {
                    }
                    if ((System.currentTimeMillis() - g.F) - com.umeng.analytics.a.h > 0) {
                        if (TextUtils.isEmpty(g.z)) {
                            if (g.av != null) {
                                g.av.t();
                                g.av = null;
                    ...
                    try {
                        if ((System.currentTimeMillis() - g.K) - com.umeng.analytics.a.h > 0) {
