...
public class e extends a implements k {
    ...
    private int D() {
        if (com.igexin.push.core.g.ai.isEmpty() && com.igexin.push.core.g.o) {
            Cursor a = com.igexin.push.core.f.a().k().a("message", new String[]{"status"}, new String[]{"0"}, null, null);
            if (a != null) {
                while (a.moveToNext()) {
                    try {
                        ...
                        pushTaskBean.setStatus(a.getInt(a.getColumnIndex("status")));
    ...
    private void f(Intent intent) {
        ...
        Cursor a;
        try {
            a = com.igexin.push.core.f.a().k().a("message", new String[]{"key"}, new String[]{str}, null, null);
            if (a != null) {
                try {
                    if (a.getCount() == 0) {
                        com.igexin.push.core.f.a().k().a("message", contentValues);
    ...
    private void h(String str) {
        ...
        try {
            ...
            try {
                fileOutputStream2.write(com.igexin.a.b.a.a(str).getBytes());
    ...
    public String a(boolean z, int i) {
        ...
        if (i == -1) {
            ...
            cursor = z ? com.igexin.push.core.f.a().k().a("bi", new String[]{"type"}, new String[]{"1", "2"}, null, null) : com.igexin.push.core.f.a().k().a("bi", new String[]{"type"}, new String[]{"2"}, null, null);
            if (cursor != null) {
                str = null;
            ...
            if (com.igexin.push.config.l.d > 0) {
                j = (long) (com.igexin.push.config.l.d * 1000);
            }
    ...
    public void a(Bundle bundle) {
        ...
        if (string.equals("setTag")) {
            ...
            if (com.igexin.push.config.l.s && com.igexin.push.core.g.an <= 200) {
                string = bundle.getString("taskid");
        ...
        try {
            if (jSONObject.has("action") && jSONObject.getString("action").equals("pushmessage")) {
                ...
                if (!(string2 == null || string == null || string3 == null || string4 == null || jSONArray == null || !string2.equals(com.igexin.push.core.g.a))) {
                    ...
                    if (z) {
                        try {
                            a = com.igexin.push.core.f.a().k().a("message", new String[]{"taskid"}, new String[]{string4}, null, null);
                            if (a != null) {
                                try {
                                    if (a.getCount() == 0) {
                                        if (jSONObject.has("condition")) {
    ...
    public boolean b(String str, String str2, String str3) {
        ...
        if (pushTaskBean == null) {
            Cursor a;
            try {
                a = com.igexin.push.core.f.a().k().a("message", new String[]{"taskid", "messageid"}, new String[]{str, str2}, null, null);
                if (a != null) {
                    try {
                        if (a.getCount() > 0) {
                            while (a.moveToNext()) {
    ...
    public int d() {
        ...
        if (com.igexin.push.core.g.l) {
            ...
            com.igexin.push.core.g.L = (((long) Math.abs(new Random().nextInt() % 24)) * com.umeng.analytics.a.i) + System.currentTimeMillis();
        }
        w.b();
        ...
        try {
            ...
            a = com.igexin.push.core.f.a().k().a("bi", new String[]{"type"}, new String[]{"1"}, null, null);
            if (a != null) {
                try {
                    if (a.getCount() == 0) {
                        ContentValues contentValues = new ContentValues();
                        ...
                        while (a.moveToNext()) {
                            ...
                            String string2 = a.getString(a.getColumnIndexOrThrow("id"));
                            ...
                            if (format.equals(string)) {
                                ...
                                com.igexin.push.core.f.a().k().a("bi", contentValues2, new String[]{"id"}, new String[]{string2});
                            } else {
                                contentValues2 = new ContentValues();
        ...
        if (size > 0) {
            ...
            try {
                ...
                for (int i = 0; i < size; i++) {
                    JSONObject jSONObject2 = new JSONObject();
                    jSONObject2.put("appid", ((com.igexin.push.core.bean.l) arrayList.get(i)).d());
                    jSONObject2.put("name", ((com.igexin.push.core.bean.l) arrayList.get(i)).b());
                    jSONObject2.put("version", ((com.igexin.push.core.bean.l) arrayList.get(i)).c());
        ...
        if (file.exists()) {
            ...
            while (i < length) {
                ...
                if (list[i].startsWith(str2) && list[i].endsWith(".log") && length2 > str2.length() + 14 && str2.equals(list[i].substring(0, length2 - 15))) {
                    try {
                        if (Math.abs((simpleDateFormat.parse(format).getTime() - simpleDateFormat.parse(list[i].substring(str2.length() + 1, length2 - 4)).getTime()) / com.umeng.analytics.a.h) > 6) {
    ...
    public void z() {
        ...
        for (Entry entry : com.igexin.push.core.g.am.entrySet()) {
            if (currentTimeMillis - ((Long) entry.getValue()).longValue() > com.umeng.analytics.a.i) {
