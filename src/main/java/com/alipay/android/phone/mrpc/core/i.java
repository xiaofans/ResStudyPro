...
public final class i implements HttpClient {
    ...
    private static final HttpRequestInterceptor d = new j();
    final HttpClient b;
    ...
    public static i a(String str) {
        ...
        schemeRegistry.register(new Scheme("https", SSLCertificateSocketFactory.getHttpSocketFactory(ConnectionUtils.CONNECTION_TIMEOUT, null), 443));
