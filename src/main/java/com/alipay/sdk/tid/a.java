...
*/
    ...
    L_0x0020:
        ...
        r0 = com.alipay.sdk.util.b.c(r0);	 Catch:{ Exception -> 0x0059, all -> 0x009c }
    ...
    private void b(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String str4) {
        int i = 0;
        String a = b.a(1, str3, com.alipay.sdk.util.b.c((Context) this.c.get()));
    ...
    public final void a(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String str4) {
        sQLiteDatabase.execSQL("update tb_tid set tid=?, key_tid=?, dt=datetime('now', 'localtime') where name=?", new Object[]{b.a(1, str3, com.alipay.sdk.util.b.c((Context) this.c.get())), str4, c(str, str2)});
    }
