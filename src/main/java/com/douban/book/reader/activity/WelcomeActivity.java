...
public class WelcomeActivity extends BaseActivity {
    ...
    private static String[] PRE_RELEASE_MARKETS = new String[]{"91_market", "Baidu_Market", "Hiapk_Market"};
    ...
    private Uri getRedirectUri() {
        ...
        if (intent != null) {
            ...
            if (StringUtils.equals((CharSequence) "com.douban.book.reader", action) || StringUtils.equals(Constants.ACTION_OPEN_BOOK, action) || StringUtils.equals((CharSequence) "android.intent.action.VIEW", action) || intent.hasCategory("android.intent.category.BROWSABLE")) {
