...
public abstract class BaseDrawerActivity extends BaseActivity {
    private int mClickedDrawerMenuItemResId = 0;
    private DrawerItemClickHelper mDrawerItemClickHelper = new DrawerItemClickHelper();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mDrawerToggle = new ActionBarDrawerToggle(this, this.mDrawerLayout, R.string.content_description_drawer_open, R.string.content_description_drawer_close) {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        boolean drawerVisible = this.mDrawerLayout.isDrawerVisible(8388611);
