    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mTencent.login((Activity) this, "get_user_info", new IUiListener() {
            public void onComplete(Object result) {
                ...
                String openId = resultJson.optString("openid");
                String accessToken = resultJson.optString("access_token");
                String expiresIn = resultJson.optString("expires_in");
                ...
                EventBusUtils.post(new OpenIdAuthenticatedEvent(103, openId, accessToken));
