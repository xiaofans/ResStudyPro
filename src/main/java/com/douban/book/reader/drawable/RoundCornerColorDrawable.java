...
public class RoundCornerColorDrawable extends ColorDrawable {
    private static final int DEFAULT_CORNER_RADIUS = Res.getDimensionPixelSize(R.dimen.btn_round_corner_radius);
    private static final int DEFAULT_STROKE_COLOR = Res.getColor(R.array.btn_stroke_color);
    private static final int DEFAULT_STROKE_WIDTH = 0;
    private int mRadius = DEFAULT_CORNER_RADIUS;
    private int mStrokeColor = DEFAULT_STROKE_COLOR;
    private boolean mStrokeEnabled = false;
