...
public class PurchaseCard extends Card<PurchaseCard> {
    ...
    private View mLayoutPurchaseSecretly;
    ...
    void updateViews() {
        ...
        try {
            ...
            if (this.mUriType == 0) {
                ...
                ViewUtils.visible(this.mLayoutPurchaseSecretly);
                ...
                ViewUtils.gone(this.mLayoutPurchaseSecretly);
            }
    ...
    private void findViews() {
        ...
        this.mLayoutPurchaseSecretly = findViewById(R.id.layout_purchase_secretly);
