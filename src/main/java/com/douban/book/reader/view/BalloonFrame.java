...
public class BalloonFrame extends ScrollView {
    private static final int INDICATOR_HEIGHT = Utils.dp2pixel(10.0f);
    private static final int INDICATOR_WIDTH = Utils.dp2pixel(20.0f);
    private static final int MAX_HEIGHT = Utils.dp2pixel(300.0f);
    private static final int MAX_WIDTH = Utils.dp2pixel(500.0f);
    private static final int PADDING = (INDICATOR_HEIGHT + Dimen.SHADOW_WIDTH);
    private static final String TAG = BalloonFrame.class.getSimpleName();
    private int mBgColorResId = R.array.page_highlight_bg_color;
    private HotArea mHotArea = null;
    private int mIndicatorOffset = 0;
    private boolean mIndicatorOnTop = false;
    LayoutParams mLayoutParams = null;
    private int mLeftMinMargin = 0;
    private int mMaxHeight = -1;
    private Path mPath = null;
    private boolean mShowIndicator = true;
    private int mTopMinMargin = 0;
