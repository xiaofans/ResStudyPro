...
public class ParagraphView extends TextView {
    ...
    Bitmap mBitmap = null;
    Bitmap[] mBitmapSlice = null;
    private boolean mBlockQuote;
    private int mBlockQuoteDecoratorResId = -1;
    private Touchable mClickedTouchable = null;
    private boolean mExpanded = false;
    private Indent mFirstLineIndent = Indent.AUTO;
    private boolean mInvalidated = true;
    private boolean mLinkEnabled = true;
    private boolean mLocalDrawingCacheEnabled = false;
    private OnExpandStatusChangedListener mOnExpandStatusChangedListener = null;
    Paint mPaint = new Paint();
    List<Paragraph> mParagraphList = null;
    private boolean mShowBullet;
    private List<Touchable> mTouchableArray = null;
    private float mTouchedDownX;
    private float mTouchedDownY;
    private int mVisibleLineCount = Integer.MAX_VALUE;
    ...
    private void init(AttributeSet attrs) {
        this.mVisibleLineCount = AttrUtils.getInteger(attrs, 16843091, Integer.MAX_VALUE);
    }
    ...
    public void setBlockQuoteLineColor(@ArrayRes @ColorRes int resId) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mLocalDrawingCacheEnabled) {
            try {
                ...
                if (this.mBitmapSlice != null) {
                    for (int i = 0; i < this.mBitmapSlice.length; i++) {
                        canvas.drawBitmap(this.mBitmapSlice[i], (float) getPaddingLeft(), ((float) (getPaddingTop() + (i * 2048))) - getHalfLineSpacing(), this.mPaint);
                    }
                }
