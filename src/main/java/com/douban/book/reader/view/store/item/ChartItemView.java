...
public class ChartItemView extends RelativeLayout {
    ...
    private static final int[][] THEME = new int[][]{new int[]{R.array.topic_widget_title_theme_orange, R.array.topic_widget_bg_theme_orange}, new int[]{R.array.topic_widget_title_theme_green, R.array.topic_widget_bg_theme_green}, new int[]{R.array.topic_widget_title_theme_blue, R.array.topic_widget_bg_theme_blue}};
    @ViewById(2131558949)
    Button mBtnChart;
    @ViewById(2131558462)
    TextView mTitle;
    ...
    public void setChart(final Chart chart, int theme) {
        ...
        this.mBtnChart.setOnClickListener(new OnClickListener() {
