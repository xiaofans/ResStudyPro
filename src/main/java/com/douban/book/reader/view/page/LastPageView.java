...
public class LastPageView extends AbsPageView {
    ...
    void updateViews() {
        ...
        if (this.mWorks.price <= 0 || this.mWorks.promotion == null) {
            ...
            purchaseBtnText = new SpannableStringBuilder(Res.getString(this.mWorks.isColumnOrSerial() ? R.string.btn_purchase_whole_works : R.string.btn_purchase_works, "")).append(this.mWorks.formatPrice());
        }
