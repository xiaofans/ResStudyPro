...
public class PriceLabelView extends BaseThemedView {
    private static final int HEIGHT = Utils.dp2pixel(16.0f);
    private static final float LABEL_PADDING_HORIZONTAL = PRICE_PADDING_HORIZONTAL;
    private static final float LABEL_TEXT_SIZE = (PRICE_TEXT_SIZE * 0.75f);
    private static final float PRICE_PADDING_HORIZONTAL = Res.getDimension(R.dimen.general_subview_horizontal_padding_small);
    private static final float PRICE_TEXT_SIZE = Res.getDimension(R.dimen.general_font_size_medium);
