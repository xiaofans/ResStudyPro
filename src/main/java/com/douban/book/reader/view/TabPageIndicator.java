...
public class TabPageIndicator extends LinearLayout implements PageIndicator {
    ...
    protected View createTabIndicatorItem(final int index) {
        final TextView tabItem = new TextView(getContext());
        ...
        tabItem.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                if (TabPageIndicator.this.mViewPager.getCurrentItem() != index) {
