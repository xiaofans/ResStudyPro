...
public class DepositAmountSelectionCard extends Card<DepositAmountSelectionCard> {
    private static final int[] DEPOSIT_AMOUNT_ARRAY = new int[]{200, 1000, 2000, BaseImageDownloader.DEFAULT_HTTP_CONNECT_TIMEOUT, AbstractSpiCall.DEFAULT_TIMEOUT};
    ...
    private void init() {
        ...
        noContentPadding();
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.amount_group);
        int checkedViewId = 0;
        ...
        btnDeposit.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                int checkedAmountId = radioGroup.getCheckedRadioButtonId();
