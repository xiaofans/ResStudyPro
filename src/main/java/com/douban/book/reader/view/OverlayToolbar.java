...
public class OverlayToolbar extends Toolbar {
    private static final float BADGE_CENTER_X = ((float) Utils.dp2pixel(38.0f));
    private static final float BADGE_CENTER_Y = ((float) Utils.dp2pixel(20.0f));
    ...
    private static final int MASK_COLOR = Res.getColorOverridingAlpha(17170444, ReadViewPager.EDGE_RATIO);
    ...
    private void updatePopupTheme() {
        setPopupTheme(Theme.isNight() ? R.style.AppBaseTheme : R.style.AppBaseTheme.Light);
    }
}
