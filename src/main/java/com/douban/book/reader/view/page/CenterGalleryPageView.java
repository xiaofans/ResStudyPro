...
public class CenterGalleryPageView extends AbsGalleryPageView {
    ...
    private OnTouchListener mDragLegendListener = new OnTouchListener() {
    ...
    private int mDraggedY = 0;
    GestureDetectorCompat mGeneralGestureDetector = null;
    private IllusMode mIllusMode = IllusMode.NORMAL;
    private IllusParagraph mIllusParagraph;
    private float mLastDragY;
    private PointF mLastTouchedPoint = new PointF();
    View mLegendPanel;
    ScaleGestureDetector mScaleDetector = new ScaleGestureDetector(getContext(), new SimpleOnScaleGestureListener() {
    ...
    private boolean mZoomInPlace = true;
