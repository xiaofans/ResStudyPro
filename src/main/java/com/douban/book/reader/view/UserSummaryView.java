...
public class UserSummaryView extends LinearLayout {
    ...
    @Click({2131558535, 2131558658, 2131558607})
    ...
    public void onEventMainThread(NotificationLastCheckedTimeUpdatedEvent event) {
        refreshNotificationStatus();
    }
    ...
    void refreshNotificationStatus() {
        try {
            updateNotificationView(this.mNotificationManager.hasNewNotificationsSinceLastCheck());
        } catch (Exception e) {
            Logger.e(TAG, e);
        }
    }
