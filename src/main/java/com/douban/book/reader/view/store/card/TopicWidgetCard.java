...
public class TopicWidgetCard extends BaseWidgetCard<TopicStoreWidgetEntity> {
    ...
    protected void onEntityBound(final TopicStoreWidgetEntity entity) {
            ...
            if (!(entity.payload == null || entity.payload.moreBtn == null)) {
                titleClickListener(new OnClickListener() {
                    public void onClick(View v) {
                        PageOpenHelper.from(TopicWidgetCard.this).open(entity.payload.moreBtn.uri);
                    }
                });
            }
