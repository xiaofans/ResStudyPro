...
public class ReadViewPager extends ViewPager {
    ...
    private final App mApp = App.get();
    private float mClickedDownX;
    private float mClickedDownY;
    GestureDetector mGestureDetector = new GestureDetector(getContext(), new OnGestureListener() {
    ...
    private OnEdgePageArrivedListener mOnEdgePageArrivedListener = null;
    private OnViewPagerClickListener mOnViewPagerClickListener = null;
