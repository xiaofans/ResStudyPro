...
public class ColumnInfoCard extends Card<ColumnInfoCard> {
    ...
    void updateViews(Works works) {
        ...
        if (works.schedule == null) {
            ...
            ViewUtils.setTextAppearance(getContext(), this.mColumnPlanInfo, R.style.AppWidget.Text.Secondary);
            this.mBtnSubscribe.setVisibility(8);
        } else {
            ...
            ViewUtils.setTextAppearance(getContext(), this.mColumnPlanInfo, R.style.AppWidget.Text.Content);
