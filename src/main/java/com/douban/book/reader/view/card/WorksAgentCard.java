...
public class WorksAgentCard extends Card<WorksAgentCard> {
    ...
    private void init() {
        ...
        this.mDescription.setVisibleLineCount(5);
    ...
    void refreshViews(WorksAgent worksAgent) {
        if (worksAgent != null) {
            ...
            if (this.mLinkEnabled) {
                ...
                ViewUtils.setTextAppearance(getContext(), this.mPublishInfo, R.style.AppWidget.Text.Link.Medium);
            } else {
                ViewUtils.setTextAppearance(getContext(), this.mPublishInfo, R.style.AppWidget.Text.Secondary);
            }
