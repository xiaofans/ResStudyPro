...
public class RoundTipView extends BaseThemedView {
    ...
    private float mTextSize = Res.getDimension(R.dimen.general_font_size_normal);
    private int mTipColorResId = R.array.red;
    ...
    public RoundTipView textSize(float textSize) {
        this.mTextSize = textSize;
        return this;
    }

    public RoundTipView textColorResId(@ArrayRes @ColorRes int resId) {
        this.mTextColorResId = resId;
        return this;
    }

    public RoundTipView tipColorResId(@ArrayRes @ColorRes int resId) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Res.getColor(this.mTextColorResId));
