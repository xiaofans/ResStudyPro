...
public class BoxedWorksView extends BaseThemedViewGroup {
    ...
    private static final String TAG = BoxedWorksView.class.getSimpleName();
    private Rect mBoxRect = new Rect();
    private Path mClosedBoxCover = new Path();
    private Rect mCoverRect = new Rect();
    private boolean mIsDepleted;
    private boolean mIsOpened;
    private Matrix mMatrix = new Matrix();
    private Path mOpenedBoxLeftTopBorder = new Path();
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        this.mWorksCoverView.measure(MeasureSpec.makeMeasureSpec(this.mCoverRect.width(), Integer.MIN_VALUE), MeasureSpec.makeMeasureSpec(this.mCoverRect.height(), 1073741824));
