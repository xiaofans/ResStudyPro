...
public class ShelfManager {
    ...
    public void addShortCut(final int worksId) throws DataLoadException {
        final Works works = (Works) this.mWorksManager.getFromCache(Integer.valueOf(worksId));
        ImageLoaderUtils.loadImage(works.coverUrl, new ImageSize(Utils.dp2pixel(48.0f), Utils.dp2pixel(48.0f)), new SimpleImageLoadingListener() {
            public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
                Intent addIntent = new Intent("com.android.launcher.action.INSTALL_SHORTCUT");
                addIntent.putExtra("android.intent.extra.shortcut.INTENT", ShelfManager.this.getShortcutIntent(worksId));
