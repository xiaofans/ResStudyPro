...
public class VersionManager {
    ...
    private static final List<String> sSupportedFeatures = new ArrayList(Arrays.asList(new String[]{"formula", "code", "gallery"}));
    ...
    public void promptAppUpdateIfNeeded() {
        ...
        if (currentTime - lastUpdate > a.h && Utils.isUsingWifi()) {
            promptAppUpdate();
