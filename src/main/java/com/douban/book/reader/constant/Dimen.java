...
public class Dimen {
    public static final float CORNER_RADIUS = ((float) Utils.dp2pixel(2.0f));
    public static final float MIN_TOUCH_AREA_SIZE = ((float) Utils.dp2pixel(48.0f));
    public static final int NAVIGATION_BAR_HEIGHT = getNavigationBarHeight();
    public static final int SHADOW_WIDTH = Utils.dp2pixel(3.0f);
    ...
    private static int getStatusBarHeight() {
        ...
        int resourceId = Res.get().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
