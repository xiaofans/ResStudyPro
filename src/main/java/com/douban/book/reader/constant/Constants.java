...
public class Constants {
    ...
    public static final String MAGIC = Secure.getString(App.get().getContentResolver(), "android_id").substring(6);
    ...
    public static final int[] TEXTSIZE_CATALOG = new int[]{15, 19, 22};
    public static final int[] TEXTSIZE_GALLERY_LEGEND = new int[]{14, 16, 18, 20, 22};
