...
public class NoteDetailFragment extends BaseFragment {
    ...
    @Background
    void loadData(final Object idOrUuidToLoad) {
        try {
            ...
            Logger.e(this.TAG, e);
            showLoadErrorPage(this.mLoadErrorViewBase, e, new RefreshClickListener() {
                public void onClick() {
                    NoteDetailFragment.this.loadData(idOrUuidToLoad);
                }
            });
        } finally {
