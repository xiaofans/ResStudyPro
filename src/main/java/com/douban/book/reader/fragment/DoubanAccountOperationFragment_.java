...
public final class DoubanAccountOperationFragment_ extends DoubanAccountOperationFragment implements HasViews {
    ...
    private void injectFragmentArguments_() {
        ...
        if (args_ != null) {
            if (args_.containsKey("action")) {
                this.action = (Action) args_.getSerializable("action");
            }
            if (args_.containsKey("intentToStartAfterLogin")) {
                this.intentToStartAfterLogin = (Intent) args_.getParcelable("intentToStartAfterLogin");
            }
            if (args_.containsKey("requestToSendAfterLogin")) {
                this.requestToSendAfterLogin = (ArkRequest) args_.getSerializable("requestToSendAfterLogin");
            }
        }
    }
}
