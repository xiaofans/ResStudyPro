...
public class GiftPackCreateFragment extends BaseContentFragment {
    ...
    void init() {
        ...
        this.mRoundTipView1.text("1").textSize(Res.getDimension(R.dimen.general_font_size_large)).showTipTail(true).tipColorResId(R.array.red);
        this.mRoundTipView2.text("2").textSize(Res.getDimension(R.dimen.general_font_size_large)).showTipTail(true).tipColorResId(R.array.red);
        loadData();
    }
    ...
    @org.androidannotations.annotations.Click({2131558605})
