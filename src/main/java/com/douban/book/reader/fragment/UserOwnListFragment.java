...
public class UserOwnListFragment extends BaseEndlessListFragment<Works> {
    @InstanceState
    boolean mBriefMode = Pref.ofApp().getBoolean(Key.APP_SHOW_USER_OWN_LIST_IN_BRIEF_MODE, false);
    @OptionsMenuItem({2131558992})
    ...
    public BaseArrayAdapter<Works> onCreateAdapter() {
        return new ViewBinderAdapter<Works>(WorksItemView_.class) {
