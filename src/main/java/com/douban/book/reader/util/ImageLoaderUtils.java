...
public class ImageLoaderUtils {
    ...
    private static DisplayImageOptions sDefaultDisplayOptions = new Builder().cacheInMemory(true).cacheOnDisk(true).imageScaleType(ImageScaleType.EXACTLY).displayer(new FadeInBitmapDisplayer(400, true, true, false)).build();
    ...
    private static void doDisplayImage(String uri, ImageView imageView, int defaultResId, boolean skipDiskCache) {
        ...
        sInstance.displayImage(uri, imageView, options, new SimpleImageLoadingListener() {
            public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
                ...
                if ((loadedImage.getWidth() > 2048 || loadedImage.getHeight() > 2048) && !ViewUtils.isSoftLayerType(view)) {
