...
public class RichText extends SpannableStringBuilder {
    ...
    public static RichText textWithColoredIcon(@DrawableRes int iconResId, @ArrayRes @ColorRes int iconColorResId, CharSequence str) {
        return textWithColoredIcon(iconResId, iconColorResId, str, false);
    }

    public static RichText textWithColoredIcon(@DrawableRes int iconResId, @ArrayRes @ColorRes int iconColorResId, @StringRes int strResId) {
    ...
    private static RichText textWithColoredIcon(@DrawableRes int iconResId, @ArrayRes @ColorRes int iconColorResId, CharSequence str, boolean useOriginalIconColor) {
