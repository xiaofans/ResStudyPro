...
public class Res {
    ...
    private static LruCache<Integer, Animation> sAnimationCache = new LruCache<Integer, Animation>(5) {
    ...
    public static int getColor(@ArrayRes @ColorRes int id) {
        if (isThemedResId(id)) {
    ...
    public static ColorStateList getColorStateList(@ArrayRes @ColorRes int id) {
        if (isThemedResId(id)) {
    ...
    public static Drawable getDrawable(@ArrayRes @DrawableRes int id) {
        if (id <= 0) {
            return null;
        }
        if (isThemedResId(id)) {
    ...
    public static Drawable getDrawableWithTint(@ArrayRes @DrawableRes int id, @ArrayRes @ColorRes int tintRes) {
        return getDrawableWithTint(getDrawable(id), tintRes);
    }

    public static Drawable getDrawableWithTint(Drawable drawable, @ArrayRes @ColorRes int tintRes) {
        if (tintRes <= 0) {
            return drawable;
        }
    ...
    public static int getColorOverridingAlpha(@ArrayRes @ColorRes int resId, float alpha) {
        if (alpha < 0.0f || alpha > 1.0f) {
            throw new IllegalArgumentException("alpha must between 0 and 1.");
        }
