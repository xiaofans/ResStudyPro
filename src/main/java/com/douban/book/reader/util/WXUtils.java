...
public class WXUtils {
    private static String TAG = WXUtils.class.getSimpleName();
    ...
    private static final IWXAPI sWxApi = WXAPIFactory.createWXAPI(App.get(), "wx72811b1bff66105e", true);
    ...
    public static class MessageBuilder {
        ...
        public MessageBuilder thumbnail(String url) {
            if (StringUtils.isNotEmpty(url)) {
                Bitmap bitmap = ImageLoaderUtils.loadImageSync(url, new ImageSize(96, 96));
                if (bitmap != null) {
        ...
        public MessageBuilder imageData(String url) {
            Bitmap bitmap = ImageLoaderUtils.loadImageSync(url, new ImageSize(400, 400));
    ...
    static {
        sWxApi.registerApp("wx72811b1bff66105e");
    }
