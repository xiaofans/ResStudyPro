...
public class ThemedUtils {
    public static ColorFilter NIGHT_MODE_COLOR_FILTER = new PorterDuffColorFilter(NIGHT_MODE_MASK_COLOR, Mode.SRC_ATOP);
    public static final int NIGHT_MODE_MASK_COLOR = Res.getColorOverridingAlpha(17170444, CharUtils.FULL_WIDTH_CHAR_OFFSET_ADJUSTMENT_RATIO);
    ...
    public static void applyThemeToView(View view, Theme theme, ThemedAttrs themedAttrs) {
        for (Integer intValue : themedAttrs.attrs()) {
            ...
            Drawable[] drawables;
            switch (attr) {
                case R.attr.autoDimInNightMode:
                    try {
                ...
                case R.attr.backgroundColorArray:
                ...
                case R.attr.dividerArray:
                    ...
                    break;
                case R.attr.roundCornerStrokeColorArray:
