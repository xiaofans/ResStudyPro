...
public class ViewUtils {
    ...
    public static class Builder {
        ...
        private void applyChangedBits(LayoutParams params) {
            ...
            if ((params instanceof LinearLayout.LayoutParams) && (this.mLayoutParams instanceof LinearLayout.LayoutParams) && hasBit(64)) {
            ...
            for (Entry<Integer, Object> entry : this.mMap.entrySet()) {
                switch (((Integer) entry.getKey()).intValue()) {
                    case 16843146:
                        ...
                        ((RelativeLayout.LayoutParams) params).addRule(8, ((Integer) entry.getValue()).intValue());
                        break;
                    default:
                        break;
                }
