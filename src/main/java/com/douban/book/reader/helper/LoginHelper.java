...
public class LoginHelper {
    ...
    void confirmMigrate(final String lastAccessToken) {
        new Builder().setMessage((int) R.string.dialog_message_merge_anonymous_data).setPositiveButton((int) R.string.dialog_button_merge_anonymous_data, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                LoginHelper.this.migrateLastUserDataAndRedirect(lastAccessToken);
            }
        }).setNegativeButton((int) R.string.dialog_button_discard_anonymous_data, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
