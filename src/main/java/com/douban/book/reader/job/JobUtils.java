...
public class JobUtils {
    ...
    private static JobManager sJobManager = new JobManager(App.get(), new Builder(App.get()).minConsumerCount(1).maxConsumerCount(3).loadFactor(3).consumerKeepAlive(120).customLogger(new CustomLogger() {
