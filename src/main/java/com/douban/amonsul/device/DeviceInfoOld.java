...
public final class DeviceInfoOld {
    private static final String TAG = DeviceInfoOld.class.getSimpleName();
    ...
    public static String getTimeZone(Context context) {
        try {
            ...
            if (config.locale != null) {
                ...
                zone = c.getTimeZone();
                if (zone != null) {
                    return "" + (zone.getRawOffset() / Constants.TIME_1HOUR_MILLISECOND);
                }
    ...
    private static JSONObject toJson(Context context) {
        ...
        try {
            ...
            try {
                ...
                obj2.put(StatConstant.JSON_KEY_OS, "android");
                return obj2;
