...
public class StatEvent {
    private static final String TAG = StatEvent.class.getSimpleName();
    ...
    public static StatEvent setupEvent(Context context, String eventId, String label, int count, String action) {
        return setupEvent(context, eventId, label, count, action, "");
    }
    ...
    public void parseJson(String jsonStr) {
        try {
            ...
            this.net = obj.optString(StatConstant.JSON_KEY_NET, "");
            this.version = obj.optString(StatConstant.JSON_KEY_EVENT_VERSION, "");
            this.attributes = obj.optString(StatConstant.JSON_KEY_EVENT_ATTRIBUTES, "");
        } catch (Throwable e) {
            StatLogger.e(TAG, e);
        }
    }
