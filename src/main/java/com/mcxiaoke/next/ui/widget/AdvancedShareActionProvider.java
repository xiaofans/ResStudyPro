...
public class AdvancedShareActionProvider extends ActionProvider implements OnMenuItemClickListener {
    ...
    public List<ShareTarget> getDefaultShareTargets() {
        return this.mShareTargets.subList(0, Math.min(this.mDefaultLength, this.mShareTargets.size()));
    }
    ...
    private void loadShareTargets() {
        if (this.mIntent != null) {
            ...
            List<ResolveInfo> activities = this.mPackageManager.queryIntentActivities(this.mIntent, 65536);
