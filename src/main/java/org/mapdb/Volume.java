...
public abstract class Volume {
    static final /* synthetic */ boolean $assertionsDisabled = (!Volume.class.desiredAssertionStatus());
    ...
    public static abstract class ByteBufferVol extends Volume {
        ...
        public final boolean tryAvailable(long offset) {
            ...
            try {
                ...
                chunks2 = (ByteBuffer[]) Arrays.copyOf(chunks2, Math.max(chunkPos + 1, chunks2.length + (chunks2.length / 1000)));
    ...
    public static final class FileChannelVol extends Volume {
        ...
        public final long getSixLong(long offset) {
            try {
                ...
                return (((((((long) (buf.get(0) & 255)) << 40) | (((long) (buf.get(1) & 255)) << 32)) | (((long) (buf.get(2) & 255)) << 24)) | (((long) (buf.get(3) & 255)) << 16)) | (((long) (buf.get(4) & 255)) << 8)) | (((long) (buf.get(5) & 255)) << null);
            } catch (IOException e) {
                throw new IOError(e);
            }
        }
    ...
    public int getUnsignedShort(long offset) {
        return ((getByte(offset) & 255) << 8) | (getByte(1 + offset) & 255);
    }
    ...
    public void putUnsignedByte(long offset, int b) {
        putByte(offset, (byte) (b & 255));
    }

    public long getSixLong(long pos) {
        return (((((((long) (getByte(0 + pos) & 255)) << 40) | (((long) (getByte(1 + pos) & 255)) << 32)) | (((long) (getByte(2 + pos) & 255)) << 24)) | (((long) (getByte(3 + pos) & 255)) << 16)) | (((long) (getByte(4 + pos) & 255)) << 8)) | (((long) (getByte(5 + pos) & 255)) << null);
    }
    ...
    public int putPackedLong(long pos, long value) {
        if ($assertionsDisabled || value >= 0) {
            ...
            while ((-128 & value) != 0) {
                ret = ret2 + 1;
                putUnsignedByte(((long) ret2) + pos, (((int) value) & 127) | 128);
                value >>>= 7;
                ret2 = ret;
            }
            ret = ret2 + 1;
    ...
    public static Factory fileFactory(File indexFile, int rafMode, boolean readOnly, long sizeLimit, int chunkShift, int sizeIncrement, File physFile, File transLogFile, boolean asyncWriteEnabled) {
        ...
        final int i = rafMode;
        final boolean z = readOnly;
        final long j = sizeLimit;
        final int i2 = chunkShift;
        final int i3 = sizeIncrement;
        final boolean z2 = asyncWriteEnabled;
        final File file2 = physFile;
        final File file3 = transLogFile;
        return new Factory() {
            public Volume createIndexVolume() {
                ...
                return Volume.volumeForFile(file, z, z, j, i2, i3, z2);
            }

            public Volume createPhysVolume() {
                return Volume.volumeForFile(file2, i > 0, z, j, i2, i3, z2);
            }

            public Volume createTransLogVolume() {
                return Volume.volumeForFile(file3, i > 0, z, j, i2, i3, z2);
            }
        };
    }
