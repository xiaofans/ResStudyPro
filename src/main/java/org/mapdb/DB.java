...
public class DB {
    static final /* synthetic */ boolean $assertionsDisabled = (!DB.class.desiredAssertionStatus());
    ...
    public class HTreeMapMaker {
        ...
        protected final String name;
        protected Function1<?, ?> valueCreator = null;
    ...
    public synchronized <K, V> HTreeMap<K, V> getHashMap(String name, Function1<V, K> valueCreator) {
        ...
        if (ret != null) {
            ...
            if (type == null) {
                ...
                long longValue = ((Long) catGet(name + ".counterRecid")).longValue();
                int intValue = ((Integer) catGet(name + ".hashSalt")).intValue();
                long[] jArr = (long[]) catGet(name + ".segmentRecids");
                Serializer serializer = (Serializer) catGet(name + ".keySerializer", getDefaultSerializer());
                Serializer serializer2 = (Serializer) catGet(name + ".valueSerializer", getDefaultSerializer());
                long longValue2 = ((Long) catGet(name + ".expireTimeStart", Long.valueOf(0))).longValue();
                long longValue3 = ((Long) catGet(name + ".expire", Long.valueOf(0))).longValue();
                long longValue4 = ((Long) catGet(name + ".expireAccess", Long.valueOf(0))).longValue();
                long longValue5 = ((Long) catGet(name + ".expireMaxSize", Long.valueOf(0))).longValue();
                long longValue6 = ((Long) catGet(name + ".expireStoreSize", Long.valueOf(0))).longValue();
                long[] jArr2 = (long[]) catGet(name + ".expireHeads", null);
                long[] jArr3 = (long[]) catGet(name + ".expireTails", null);
                String str = name + ".hasher";
                ret = new HTreeMap(engine, longValue, intValue, jArr, serializer, serializer2, longValue2, longValue3, longValue4, longValue5, longValue6, jArr2, jArr3, valueCreator, (Hasher) catGet(str, Hasher.BASIC), false);
                namedPut(name, ret);
                hTreeMap = ret;
            }
        }
    ...
    protected synchronized <K, V> HTreeMap<K, V> createHashMap(HTreeMapMaker m) {
        ...
        ret = new HTreeMap(engine, ((Long) catPut(str, Long.valueOf(put))).longValue(), ((Integer) catPut(name + ".hashSalt", Integer.valueOf(new Random().nextInt()))).intValue(), (long[]) catPut(name + ".segmentRecids", HTreeMap.preallocateSegments(this.engine)), (Serializer) catPut(name + ".keySerializer", m.keySerializer, getDefaultSerializer()), (Serializer) catPut(name + ".valueSerializer", m.valueSerializer, getDefaultSerializer()), expireTimeStart, expire, expireAccess, expireMaxSize, expireStoreSize, expireHeads, expireTails, m.valueCreator, m.hasher, false);
    ...
    protected synchronized <K> Set<K> createHashSet(HTreeSetMaker m) {
        ...
        ret2 = new HTreeMap(engine, ((Long) catPut(str, Long.valueOf(put))).longValue(), ((Integer) catPut(name + ".hashSalt", Integer.valueOf(new Random().nextInt()))).intValue(), (long[]) catPut(name + ".segmentRecids", HTreeMap.preallocateSegments(this.engine)), (Serializer) catPut(name + ".serializer", m.serializer, getDefaultSerializer()), null, expireTimeStart, expire, expireAccess, expireMaxSize, expireStoreSize, expireHeads, expireTails, null, m.hasher, false).keySet();
    ...
    protected synchronized <K, V> BTreeMap<K, V> createTreeMap(BTreeMapMaker m) {
        ...
        if (!(m.pumpPresortBatchSize == -1 || m.pumpSource == null)) {
            final BTreeMapMaker bTreeMapMaker = m;
            m.pumpSource = Pump.sort(m.pumpSource, m.pumpIgnoreDuplicates, m.pumpPresortBatchSize, new Comparator() {
                public int compare(Object o1, Object o2) {
                    return -bTreeMapMaker.comparator.compare(bTreeMapMaker.pumpKeyExtractor.run(o1), bTreeMapMaker.pumpKeyExtractor.run(o2));
                }
        ...
        if (ret != null) {
            ...
            if (type == null) {
                ...
                if (this.engine.isReadOnly()) {
                    ...
                    string = createAtomicString(name, "");
                }
            } else {
    ...
    public synchronized void delete(String name) {
        ...
        if (r instanceof Boolean) {
            ...
            HTreeMap m = r instanceof HTreeMap ? (HTreeMap) r : ((KeySet) r).parent();
            m.clear();
