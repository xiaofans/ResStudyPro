...
public class StoreHeap extends Store implements Serializable {
    static final /* synthetic */ boolean $assertionsDisabled = (!StoreHeap.class.desiredAssertionStatus());
    protected static final Object NULL = new Object();
    protected static final Tuple2 TOMBSTONE = Fun.t2(null, null);
    ...
    protected final ConcurrentNavigableMap<Long, Tuple2> records = new ConcurrentSkipListMap();
    protected final ConcurrentNavigableMap<Long, Tuple2> rollback = new ConcurrentSkipListMap();
