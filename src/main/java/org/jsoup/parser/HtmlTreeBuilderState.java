...
enum HtmlTreeBuilderState {
                                                                                                        ...
                                                                                                        if (!name.equals("hr")) {
                                                                                                            if (!name.equals(WBConstants.GAME_PARAMS_GAME_IMAGE_URL)) {
                                                                                                                ...
                                                                                                                if (tb.getFormElement() == null) {
                                                                                                                    ...
                                                                                                                    tb.process(new Character().data(startTag.attributes.hasKey(SettingsJsonConstants.PROMPT_KEY) ? startTag.attributes.get(SettingsJsonConstants.PROMPT_KEY) : "This is a searchable index. Enter search keywords: "));
    ...
    private static final class Constants {
        ...
        static {
            ...
            InBodyStartMedia = new String[]{a.f, "source", "track"};
            InBodyStartInputAttribs = new String[]{"name", "action", SettingsJsonConstants.PROMPT_KEY};
            ...
            InBodyEndAdoptionFormatters = new String[]{DeviceType.IPAD, "b", "big", "code", "em", "font", "i", "nobr", "s", "small", "strike", "strong", "tt", "u"};
